import 'package:belajar_flutter/pages_http/future_builder.dart';
...
import 'package:belajar_flutter/pages_http/latihan_materi/latihan_delete.dart';
...
class MyAmazingApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(home: FutureBuilderPage());
  }
}
